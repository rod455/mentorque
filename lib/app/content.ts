...
export function getContent(locale: Locale) {
  ...
  const lessons: Lesson[] = [
    ...
    art({ id: "vid-oxido-nitroso", track: "sports", type: "video", system: "engine", addedAt: "2026-08-10", thumb: "/learn/vid-oxido-nitroso.png",
      ...
      art({ id: "gearbox-tipos", track: "fundamentals", system: "engine", addedAt: "2026-08-20",
    ...
    art({ id: "gearbox-fluido", track: "fundamentals", system: "engine", addedAt: "2026-08-20",
    ...
    art({ id: "gearbox-sintomas", track: "diagnosis", system: "engine", addedAt: "2026-08-20",
    ...
    art({ id: "tire-calibragem", track: "diy", system: "tires", addedAt: "2026-08-20",
    ...
    art({ id: "diag-superaquecimento", track: "diagnosis", system: "engine", addedAt: "2026-08-20",
    ...
    art({ id: "diag-vibracao", track: "diagnosis", system: "suspension", addedAt: "2026-08-20",
