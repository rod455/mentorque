export const pt = {
  ...
  hero: {
    ...
    mockupAlt: "Prévia do app Mentorque mostrando uma trilha de aprendizado e o diagnóstico por sintoma",
    carouselLabel: "Frases em destaque",
    prev: "Frase anterior",
    next: "Próxima frase",
    goTo: "Ir para a frase",
  },
  waitlist: {
  ...
  features: {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Fale com o creator e a equipe quando o vídeo não basta. Ajuda humana, direto ao ponto.",
      },
      {
        icon: "car",
        title: "Feito para o seu carro",
        body: "Personalização por marca, modelo e ano: tudo que aparece é relevante para o veículo que você tem.",
      },
      {
        icon: "community",
        title: "Comunidade e lives",
        body: "Tire dúvidas, acompanhe transmissões ao vivo e aprenda junto com gente que respira carro e moto.",
      },
    ],
  },
  how: {
  ...
  consulting: {
    ...
    tiers: [
      {
        name: "Comunidade",
        body: "Poste sua dúvida e receba orientação da comunidade e de moderadores que entendem do assunto.",
        note: "Incluído no plano gratuito",
      },
      {
        name: "Diagnóstico pela equipe",
        body: "A equipe do creator analisa seu caso (sintomas, fotos, códigos OBD2) e devolve um plano de ação claro.",
        note: "No Premium",
      },
      {
        name: "1:1 com o creator",
        body: "Sessão individual com o creator para os casos difíceis ou decisões de compra e reforma. Vagas limitadas.",
    ...
    items: [
      {
        ...
        features: [
          ...
          "Diagnóstico por sintoma (básico)",
      ...
      },
      {
        name: "Premium",
        price: "Assinatura",
        priceNote: "mensal ou anual",
        features: [
          "Todas as trilhas + certificados",
          "Ferramentas completas (OBD2, preço justo, histórico)",
          "Diagnóstico pela equipe",
          "Conteúdos e lives exclusivos",
        ],
        cta: "Quero o Premium",
        highlight: true,
      ...
      },
      {
        name: "Consultoria",
        price: "Sob consulta",
        priceNote: "pacotes e 1:1",
        features: [
          "Tudo do Premium",
          "Sessões 1:1 com o creator",
          "Acompanhamento de projeto/reforma",
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Para ler os códigos do carro você usa um adaptador OBD2 comum (vendido a partir de poucas dezenas de reais). O app guia a leitura e explica o que cada código significa.",
      },
      {
