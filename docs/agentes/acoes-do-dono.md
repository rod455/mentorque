...
| 2026-09-10 | No Google Cloud (projeto 1009695078013), criar um cliente OAuth do tipo Android com pacote `mentorque.app` e SHA-1 `E5:1C:71:4E:AF:82:E6:58:E7:6A:46:96:E0:81:3E:50:5C:91:71:CC` | É o certificado que assina o app instalado no aparelho, lido pela 2.3; sem ele o Google devolve "cancelado" depois de escolher a conta, e é isso que está segurando o login do Android há dois dias. Não precisa de build | Esta rodada |
| 2026-09-07 | Ao publicar a 2.3, acrescentar `"2.3"` à lista `JA_PUBLICADAS` em `scripts/verifica-versoes.mjs` | Foi esquecer isto na 1.8 que deixou a conferência calada e mandou um segundo build com o mesmo nome de versão, cegando o funil e a tabela de erros para a diferença entre os dois | Esta rodada |
