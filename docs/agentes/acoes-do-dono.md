...
| 2026-09-19 | Aplicar também as negativas de scanner no Google Ads: `scanner`, `obd2`, `bluetooth`, `elm327` | Os termos de "scanner de carro pelo celular" gastaram R$ 30 em 7 dias e não deram nenhuma conta. O app NÃO lê o carro por Bluetooth (o OBD2 é a pessoa digitando o código), então essa intenção não é atendida e quem clica descobre na primeira tela. Ninguém tinha olhado esse grupo até agora | Mídia paga |
