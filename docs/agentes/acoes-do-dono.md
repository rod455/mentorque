...
| 2026-09-24 | **DECIDIR se o Android vai vender assinatura.** Hoje ele roda em modo leitor: a tela de assinatura aparece e não tem botão de compra, porque a política do Play exige o Play Billing para convidar à compra. O interruptor é a ausência da chave `NEXT_PUBLIC_REVENUECAT_ANDROID_KEY` no build, então ligar NÃO mexe em tela nenhuma, e desligar também não | **85% de quem chega ao paywall está no Android** (28 de 33 em nove dias, contra 4 no iPhone e 1 na web). Enquanto não vender, qualquer taxa de conversão do fundo do funil é medida num denominador que não converte por construção, e nenhuma aposta de conversão tem leitura. Achado da rodada de QA de 23/09 | QA e Produto |
