...
| 2026-09-19 | Colar no perfil do Instagram o link inteligente que está pronto em `docs/utms.md`: `https://www.mentorque.com.br/baixar?utm_source=instagram&utm_medium=social&utm_campaign=bio`. Ele manda iPhone para a App Store e Android para o Google Play sozinho | Em todos os eventos desde 23/08 as origens são `google` (563), `atalho` (14) e `email` (8): `instagram` não aparece nenhuma vez. Sem a etiqueta, post que funciona e post que não funciona produzem o mesmo dado, que é nenhum, e o agente de mídia não tem como dizer se vale postar mais | Mídia paga |
