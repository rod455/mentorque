...
| 2026-09-07 | Passar o `NEXT_PUBLIC_GOOGLE_WEB_CLIENT_ID` e pôr o mesmo valor em "Authorized Client IDs" no provider Google do Supabase | Sem ele o login nativo do Android não liga, e o caminho que sobra não produziu uma conta em quatro semanas | Esta rodada |
